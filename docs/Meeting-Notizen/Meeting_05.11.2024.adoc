...
* ideale 5x5-Matrix aus Literatur entnehmen und in Prototypen zum Vergleich als weiteres Fenster einbauen -> *in process*
...
* Konzept für Benchmark entwerfen/darüber nachdenken -> *in process*
